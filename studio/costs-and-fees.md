...
* **When people mint:** you receive the **mint price minus Stargaze's 8% platform fee** — 92% of each mint. (For example, on a 10 ATOM mint you receive 9.2 ATOM.) Minters also pay a small gas fee to the network.
