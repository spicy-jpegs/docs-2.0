...
* **Keep files light:** Arweave storage is priced by size, so smaller files cost less to store and load faster. Run them through the [Image & Video Resizer](creator-tools.md) first. Large collections are supported too — the [Arweave Uploader](creator-tools.md) handles 1 GB and up.
...
* **Phases** — a whitelist, a public mint, or both? See [Whitelists](whitelists.md).
